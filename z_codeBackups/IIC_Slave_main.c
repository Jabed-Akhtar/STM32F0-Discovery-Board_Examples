...
* 			2. Full data in 6 data bytes (0th to 5th data bytes)
*		On receiving counter message, Green LED is toggled and on receiving full
*		six data bytes, Blue LED is toggled.
* LEDs:
* 	|- LD3 (PC9) -> Green
* 	|- LD4 (PC8) -> Blue
******************************************************************************
